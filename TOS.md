...
You must read this Agreement carefully as it governs your use of the Service. By accessing or using WhaleSwap, you signify that you have read, understand, and agree to be bound by this Agreement in its entirety. If you do not agree, you are not authorized to access or use the Service.

**1. Nature of the Service**

**1.1 Decentralized and Open Source**
WhaleSwap is open-source software operated entirely on-chain via smart contracts. It is not based in, nor does it operate from, any specific country or jurisdiction. **You may fork the UI repo and run it on your own server or GitHub pages. There is no dependency on this GitHub Pages site.** The code is provided "as is" for use by the general public. There is no central authority or operator controlling the transactions you execute.

**1.2 OTC Swaps and Supported Networks**
The Service facilitates peer-to-peer or smart contract-mediated OTC swaps of digital assets. **The Service currently supports ERC-20 tokens on selected EVM compatible networks like Ethereum, Polygon, and BNB Chain.** You acknowledge that you are interacting directly with the smart contracts and the underlying blockchain networks, not with a centralized service provider.

**1.3 No Fees**
WhaleSwap does not charge any service fees, trading fees, or commissions. The protocol is free to use. However, you are solely responsible for paying any network transaction fees (gas fees) required by the networks to execute your transactions. WhaleSwap does not control, receive, or refund these network fees.
...
BY ACCESSING AND USING WHALESWAP, YOU REPRESENT THAT YOU ARE FINANCIALLY AND TECHNICALLY SOPHISTICATED ENOUGH TO UNDERSTAND THE INHERENT RISKS ASSOCIATED WITH USING CRYPTOGRAPHIC AND BLOCKCHAIN-BASED SYSTEMS. YOU ACKNOWLEDGE AND AGREE THAT:

* **Smart Contract Risk:** Smart contracts may contain bugs or vulnerabilities that could result in the loss of funds.
* **Network Risks:** You are using public EVM networks. We are not responsible for network congestion, high gas fees, or failures of the underlying blockchains.
* **Asset Risk:** Anyone can create a token, including fraudulent tokens. You are responsible for verifying the authenticity and contract address of any token you wish to swap.

**3.2 No Warranties**
THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, BUT NOT LIMITED TO, IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT.
WE DO NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE. WE DO NOT GUARANTEE THE ACCURACY OR RELIABILITY OF ANY INFORMATION PROVIDED ON THE INTERFACE.

**3.3 No Financial Advice**
WhaleSwap provides no investment, financial, tax, or legal advice. The information displayed on the interface is for informational purposes only. You should consult your own advisors before engaging in any digital asset transactions.
...
If any provision of this Agreement is held to be invalid or unenforceable, the remaining provisions shall continue in full force and effect. This Agreement constitutes the entire agreement between you and WhaleSwap regarding your use of the Service.
